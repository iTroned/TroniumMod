...
using TroniumMod.Content.Biomes;

namespace TroniumMod.Content.NPCs
{
    public class ToxicZombie : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Toxic Zombie");
        ...
        public override void SetDefaults()
        {
            ...
            SpawnModBiomes = new int[1] { ModContent.GetInstance<ToxCitySurfaceBiome>().Type }; // Associates this NPC with the ExampleSurfaceBiome in Bestiary
        }
        ...
        {
            return SpawnCondition.OverworldNightMonster.Chance * 0.6f; // Spawn with 3/5th the chance of a regular zombie.
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("This Zombie mutation is extremly dangerous. Do. Not. Get. Hit!"),

				// By default the last added IBestiaryBackgroundImagePathAndColorProvider will be used to show the background image.
				// The ExampleSurfaceBiome ModBiomeBestiaryInfoElement is automatically populated into bestiaryEntry.Info prior to this method being called
				// so we use this line to tell the game to prioritize a specific InfoElement for sourcing the background image.
				new BestiaryPortraitBackgroundProviderPreferenceInfoElement(ModContent.GetInstance<ToxCitySurfaceBiome>().ModBiomeBestiaryInfoElement),
            });
        }
