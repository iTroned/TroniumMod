...
namespace TroniumMod.Content.Biomes
{
    public class ExampleUndergroundBiome : ModBiome
    {
        ...
        public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("TroniumMod/ToxCityUndergroundBackgroundStyle");
        ...
        {
            DisplayName.SetDefault("ToxCity Underground");
        }
        ...
        public override bool IsBiomeActive(Player player)
        {
            ...
            return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
                ...
                ModContent.GetInstance<ToxCityBiomeTileCounter>().exampleBlockCount >= 2 &&
