...
using TroniumMod.Common.Systems;

namespace TroniumMod.Content.Biomes
{
    public class ToxCitySurfaceBiome : ModBiome
    {
        // Select all the scenery
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("TroniumMod/ToxCityWaterStyle"); // Sets a water style for when inside this biome
        public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("TroniumMod/ToxCitySurfaceBackgroundStyle");
        ...
        public override bool IsBiomeActive(Player player)
        {
            ...
            bool b1 = ModContent.GetInstance<ToxCityBiomeTileCounter>().exampleBlockCount >= 2;
