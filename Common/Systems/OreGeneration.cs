...
namespace TroniumMod.Common.Systems
{
    ...
    public class OreGenerationSystem : ModSystem
    {
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                ...
                tasks.Insert(ShiniesIndex + 1, new OreGenerationPass("Tronium Ores", 240f));
            }
        }
    }
    ...
    public class OreGenerationPass : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = "Creating Tronium ore deposits";
            ...
            for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-03); k++)
            {
                ...
                WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<TroniumOre>());
